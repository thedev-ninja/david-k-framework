					                    ...
					                    <div class="col-xs-12">
					                        <div>
					                        	<ul class="list-group main-nav">
					                        		<li class="button full-width-button"><a href="<?php echo $dispatcher->router->generate('app_home', array('appid' => 2)); ?>">HOME</a></li>
					                        		<li class="button full-width-button"><a href="<?php echo $dispatcher->router->generate('company_listings', array('appid' => 2)); ?>">CITY SERVICES</li>
					                        		<li class="button full-width-button"><a href="<?php echo constant("APP_URIPATH"); ?>/listings/individuals/">INDIVIDUALS</a></li>
					                        		<li class="button full-width-button"><a href="<?php echo $dispatcher->router->generate('app_traffic', array('appid' => 2)); ?>">TRAFFIC MAP</a></li>
				                        		</ul>
			                        		</div>
					                    </div>
				                    </div>
